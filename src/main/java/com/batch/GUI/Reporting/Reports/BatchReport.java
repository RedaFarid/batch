...
public class BatchReport extends Stage {
    ...
    private final GridPane mainData;
    ...
    private void graphicsBuilder() {
        ...
        this.print.setPrefWidth(150.0F);
        this.export.setPrefWidth(150.0F);
        ...
        this.root.setBorder(new Border(new BorderStroke(Color.BLACK, BorderStrokeStyle.NONE, new CornerRadii(0.0F), new BorderWidths(0.0F))));
        this.root.setBackground(new Background(new BackgroundFill(Color.WHITE, new CornerRadii(0.0F), Insets.EMPTY)));
        this.center.getChildren().addAll(this.mainData, this.table);
        this.mainRoot.setPadding(new Insets(20.0F));
        this.mainRoot.setSpacing(5.0F);
        this.mainRoot.getChildren().addAll(this.root, this.print, this.export);
        ...
        this.export.setOnMouseClicked((action) -> {
            ...
            if (file != null) {
                this.consumer.accept(this.dataModel, file, () -> this.showErrorWindow("Report export", "Report exported successfully"));
            }
    ...
    private void tableGraphics() {
        Pane pane = new Pane();
        pane.setPrefSize(10.0F, 10.0F);
        this.table.setPadding(new Insets(10.0F));
        this.table.setSpacing(1.0F);
        this.table.getChildren().clear();
        this.table.getChildren().add(this.createTableHeader());
        this.dataModel.getData().stream().limit(this.dataModel.getData().size() - 1).forEach((item) -> this.table.getChildren().add(this.tableRow(item)));
        this.table.getChildren().addAll(pane);
        this.table.getChildren().addAll(this.totalsTableRow(this.dataModel.getData().get(this.dataModel.getData().size() - 1)));
    }
    ...
    private void HeaderGraphics() {
        ...
        imageView.setFitWidth(90.0F);
        imageView.setFitHeight(50.0F);
        this.Header.add(label, 1, 0);
        this.Header.add(label2, 1, 1);
        this.Header.add(imageView, 0, 0, 1, 2);
        this.Header.setHgap(10.0F);
        this.Header.setPadding(new Insets(0.0F));
        this.Header.setBorder(new Border(new BorderStroke(Color.BLACK, BorderStrokeStyle.NONE, new CornerRadii(1.0F), new BorderWidths(1.0F))));
        this.Header.setBackground(new Background(new BackgroundFill(Color.WHITE, new CornerRadii(0.0F), Insets.EMPTY)));
    ...
    private void FooterGraphics() {
        ...
        textArea.setBorder(new Border(new BorderStroke(Color.BLACK, BorderStrokeStyle.SOLID, new CornerRadii(0.0F), new BorderWidths(1.0F, 1.0F, 1.0F, 1.0F))));
        textArea.setBackground(new Background(new BackgroundFill(Color.WHITE, new CornerRadii(0.0F), new Insets(0.0F, 0.0F, 0.0F, 0.0F))));
        textArea.setPrefWidth(this.width);
        textArea.setPrefHeight(80.0F);
        ...
        Name.setBorder(new Border(new BorderStroke(Color.BLACK, BorderStrokeStyle.SOLID, new CornerRadii(0.0F), new BorderWidths(0.0F, 1.0F, 1.0F, 1.0F))));
        Name.setBackground(new Background(new BackgroundFill(Color.WHITE, new CornerRadii(0.0F), new Insets(0.0F, 0.0F, 0.0F, 0.0F))));
        ...
        Signature.setBorder(new Border(new BorderStroke(Color.BLACK, BorderStrokeStyle.SOLID, new CornerRadii(0.0F), new BorderWidths(0.0F, 1.0F, 1.0F, 0.0F))));
        Signature.setBackground(new Background(new BackgroundFill(Color.WHITE, new CornerRadii(0.0F), new Insets(0.0F, 0.0F, 0.0F, 0.0F))));
        ...
        Name2.setBorder(new Border(new BorderStroke(Color.BLACK, BorderStrokeStyle.SOLID, new CornerRadii(0.0F), new BorderWidths(0.0F, 1.0F, 1.0F, 0.0F))));
        Name2.setBackground(new Background(new BackgroundFill(Color.WHITE, new CornerRadii(0.0F), new Insets(0.0F, 0.0F, 0.0F, 0.0F))));
        ...
        Signature2.setBorder(new Border(new BorderStroke(Color.BLACK, BorderStrokeStyle.SOLID, new CornerRadii(0.0F), new BorderWidths(0.0F, 1.0F, 1.0F, 0.0F))));
        Signature2.setBackground(new Background(new BackgroundFill(Color.WHITE, new CornerRadii(0.0F), new Insets(0.0F, 0.0F, 0.0F, 0.0F))));
        ...
        NameD.setBorder(new Border(new BorderStroke(Color.BLACK, BorderStrokeStyle.SOLID, new CornerRadii(0.0F), new BorderWidths(0.0F, 1.0F, 1.0F, 1.0F))));
        NameD.setBackground(new Background(new BackgroundFill(Color.WHITE, new CornerRadii(0.0F), new Insets(0.0F, 0.0F, 0.0F, 0.0F))));
        ...
        SignatureD.setBorder(new Border(new BorderStroke(Color.BLACK, BorderStrokeStyle.SOLID, new CornerRadii(0.0F), new BorderWidths(0.0F, 1.0F, 1.0F, 0.0F))));
        SignatureD.setBackground(new Background(new BackgroundFill(Color.WHITE, new CornerRadii(0.0F), new Insets(0.0F, 0.0F, 0.0F, 0.0F))));
        ...
        Name2D.setBorder(new Border(new BorderStroke(Color.BLACK, BorderStrokeStyle.SOLID, new CornerRadii(0.0F), new BorderWidths(0.0F, 1.0F, 1.0F, 0.0F))));
        Name2D.setBackground(new Background(new BackgroundFill(Color.WHITE, new CornerRadii(0.0F), new Insets(0.0F, 0.0F, 0.0F, 0.0F))));
        ...
        Signature2D.setBorder(new Border(new BorderStroke(Color.BLACK, BorderStrokeStyle.SOLID, new CornerRadii(0.0F), new BorderWidths(0.0F, 1.0F, 1.0F, 0.0F))));
        Signature2D.setBackground(new Background(new BackgroundFill(Color.WHITE, new CornerRadii(0.0F), new Insets(0.0F, 0.0F, 0.0F, 0.0F))));
        ...
        this.Footer.setBorder(new Border(new BorderStroke(Color.BLACK, BorderStrokeStyle.NONE, new CornerRadii(0.0F), new BorderWidths(0.0F))));
        this.Footer.setBackground(new Background(new BackgroundFill(Color.WHITE, new CornerRadii(0.0F), Insets.EMPTY)));
    }
    ...
    private void mainDataGraphics() {
        ...
        this.mainData.setPadding(new Insets(10.0F, 0.0F, 0.0F, 0.0F));
        this.mainData.setBorder(new Border(new BorderStroke(Color.BLACK, BorderStrokeStyle.NONE, new CornerRadii(0.0F), new BorderWidths(0.0F))));
        this.mainData.setBackground(new Background(new BackgroundFill(Color.WHITE, new CornerRadii(0.0F), Insets.EMPTY)));
    }
    ...
    private HBox FieldTopRight(String Label, String Data, double LabelWidth, double DatWidth) {
        ...
        label.setBorder(new Border(new BorderStroke(Color.BLACK, BorderStrokeStyle.SOLID, new CornerRadii(0.0F), new BorderWidths(1.0F, 1.0F, 1.0F, 1.0F))));
        label.setBackground(new Background(new BackgroundFill(this.TABLE_LABEL_COLOR, new CornerRadii(0.0F), new Insets(0.0F, 0.0F, 0.0F, 0.0F))));
        ...
        label2.setBorder(new Border(new BorderStroke(Color.BLACK, BorderStrokeStyle.SOLID, new CornerRadii(0.0F), new BorderWidths(1.0F, 1.0F, 1.0F, 0.0F))));
        label2.setBackground(new Background(new BackgroundFill(Color.WHITE, new CornerRadii(0.0F), new Insets(0.0F, 0.0F, 0.0F, 0.0F))));
    ...
    private HBox FieldTopLeft(String Label, String Data, double LabelWidth, double DatWidth) {
        ...
        TextField label = new TextField(Label);
        label.setStyle("-fx-font-weight:bold;-fx-font-style:normal;-fx-text-fill:black;-fx-font-size:8;-fx-font-family: 'Times New Roman';");
        label.setBorder(new Border(new BorderStroke(Color.BLACK, BorderStrokeStyle.SOLID, new CornerRadii(0.0F), new BorderWidths(1.0F, 1.0F, 1.0F, 0.0F))));
        label.setBackground(new Background(new BackgroundFill(this.TABLE_LABEL_COLOR, new CornerRadii(0.0F), new Insets(0.0F, 0.0F, 0.0F, 0.0F))));
        label.setPrefWidth(LabelWidth - (double) 1.0F);
        label.setEditable(false);
        TextField label2 = new TextField(Data);
    ...
    private HBox FieldBottomRight(String Label, String Data, double LabelWidth, double DatWidth) {
        ...
        TextField label = new TextField(Label);
        label.setStyle("-fx-font-weight:bold;-fx-font-style:normal;-fx-text-fill:black;-fx-font-size:8;-fx-font-family: 'Times New Roman';");
        label.setBorder(new Border(new BorderStroke(Color.BLACK, BorderStrokeStyle.SOLID, new CornerRadii(0.0F), new BorderWidths(0.0F, 1.0F, 1.0F, 1.0F))));
        label.setBackground(new Background(new BackgroundFill(this.TABLE_LABEL_COLOR, new CornerRadii(0.0F), new Insets(0.0F, 0.0F, 0.0F, 0.0F))));
        label.setPrefWidth(LabelWidth - (double) 1.0F);
        label.setEditable(false);
        TextField label2 = new TextField(Data);
        label2.setStyle("-fx-font-weight:bold;-fx-font-style:normal;-fx-text-fill:black;-fx-font-size:8;-fx-font-family: 'Times New Roman';");
        label2.setBorder(new Border(new BorderStroke(Color.BLACK, BorderStrokeStyle.SOLID, new CornerRadii(0.0F), new BorderWidths(0.0F, 1.0F, 1.0F, 0.0F))));
        label2.setBackground(new Background(new BackgroundFill(Color.WHITE, new CornerRadii(0.0F), new Insets(0.0F, 0.0F, 0.0F, 0.0F))));
        label2.setPrefWidth(DatWidth);
        label2.setEditable(false);
        hbox.getChildren().addAll(label, label2);
    ...
    private HBox FieldBottomLeft(String Label, String Data, double LabelWidth, double DatWidth) {
        ...
        TextField label = new TextField(Label);
        label.setStyle("-fx-font-weight:bold;-fx-font-style:normal;-fx-text-fill:black;-fx-font-size:8;-fx-font-family: 'Times New Roman';");
        label.setBorder(new Border(new BorderStroke(Color.BLACK, BorderStrokeStyle.SOLID, new CornerRadii(0.0F), new BorderWidths(0.0F, 1.0F, 1.0F, 0.0F))));
        label.setBackground(new Background(new BackgroundFill(this.TABLE_LABEL_COLOR, new CornerRadii(0.0F), new Insets(0.0F, 0.0F, 0.0F, 0.0F))));
        label.setPrefWidth(LabelWidth - (double) 1.0F);
        label.setEditable(false);
        TextField label2 = new TextField(Data);
    ...
    private HBox FieldLabel(String text, double width) {
        ...
        label.setBorder(new Border(new BorderStroke(Color.BLACK, BorderStrokeStyle.SOLID, new CornerRadii(0.0F), new BorderWidths(0.0F, 1.0F, 0.0F, 1.0F))));
        label.setBackground(new Background(new BackgroundFill(this.TABLE_LABEL_COLOR.saturate().darker(), new CornerRadii(0.0F), new Insets(0.0F, 0.0F, 0.0F, 0.0F))));
        label.setPrefWidth(width);
        label.setPrefHeight(15.0F);
        HBox hbox = new HBox();
    ...
    private HBox tableRow(ReportTableDataModel recordModel) {
        ...
        No.setPadding(new Insets(1.0F));
        material.setPadding(new Insets(1.0F));
        required.setPadding(new Insets(1.0F));
        loaded.setPadding(new Insets(1.0F));
        error.setPadding(new Insets(1.0F));
        requiredPercent.setPadding(new Insets(1.0F));
        loadedPercent.setPadding(new Insets(1.0F));
        ...
        No.setBorder(new Border(new BorderStroke(Color.BLACK, BorderStrokeStyle.SOLID, new CornerRadii(0.0F), new BorderWidths(0.0F))));
        material.setBorder(new Border(new BorderStroke(Color.BLACK, BorderStrokeStyle.SOLID, new CornerRadii(0.0F), new BorderWidths(0.0F))));
        required.setBorder(new Border(new BorderStroke(Color.BLACK, BorderStrokeStyle.SOLID, new CornerRadii(0.0F), new BorderWidths(0.0F))));
        loaded.setBorder(new Border(new BorderStroke(Color.BLACK, BorderStrokeStyle.SOLID, new CornerRadii(0.0F), new BorderWidths(0.0F))));
        error.setBorder(new Border(new BorderStroke(Color.BLACK, BorderStrokeStyle.SOLID, new CornerRadii(0.0F), new BorderWidths(0.0F))));
        requiredPercent.setBorder(new Border(new BorderStroke(Color.BLACK, BorderStrokeStyle.SOLID, new CornerRadii(0.0F), new BorderWidths(0.0F))));
        loadedPercent.setBorder(new Border(new BorderStroke(Color.BLACK, BorderStrokeStyle.SOLID, new CornerRadii(0.0F), new BorderWidths(0.0F))));
        No.setBackground(new Background(new BackgroundFill(Color.WHITE, new CornerRadii(0.0F), Insets.EMPTY)));
        material.setBackground(new Background(new BackgroundFill(Color.WHITE, new CornerRadii(0.0F), Insets.EMPTY)));
        required.setBackground(new Background(new BackgroundFill(Color.WHITE, new CornerRadii(0.0F), Insets.EMPTY)));
        loaded.setBackground(new Background(new BackgroundFill(Color.WHITE, new CornerRadii(0.0F), Insets.EMPTY)));
        error.setBackground(new Background(new BackgroundFill(Color.WHITE, new CornerRadii(0.0F), Insets.EMPTY)));
        requiredPercent.setBackground(new Background(new BackgroundFill(Color.WHITE, new CornerRadii(0.0F), Insets.EMPTY)));
        loadedPercent.setBackground(new Background(new BackgroundFill(Color.WHITE, new CornerRadii(0.0F), Insets.EMPTY)));
    ...
    private HBox totalsTableRow(ReportTableDataModel recordModel) {
        ...
        requiredPercent.setAlignment(Pos.BASELINE_LEFT);
        loadedPercent.setAlignment(Pos.BASELINE_LEFT);
        Total.setPadding(new Insets(0.0F));
        required.setPadding(new Insets(0.0F));
        loaded.setPadding(new Insets(0.0F));
        error.setPadding(new Insets(0.0F));
        requiredPercent.setPadding(new Insets(0.0F));
        loadedPercent.setPadding(new Insets(0.0F));
        ...
        requiredPercent.setEditable(true);
        loadedPercent.setEditable(false);
        Total.setBorder(new Border(new BorderStroke(Color.BLACK, BorderStrokeStyle.SOLID, new CornerRadii(0.0F), new BorderWidths(0.0F))));
        required.setBorder(new Border(new BorderStroke(Color.BLACK, BorderStrokeStyle.SOLID, new CornerRadii(0.0F), new BorderWidths(0.0F))));
        loaded.setBorder(new Border(new BorderStroke(Color.BLACK, BorderStrokeStyle.SOLID, new CornerRadii(0.0F), new BorderWidths(0.0F))));
        error.setBorder(new Border(new BorderStroke(Color.BLACK, BorderStrokeStyle.SOLID, new CornerRadii(0.0F), new BorderWidths(0.0F))));
        requiredPercent.setBorder(new Border(new BorderStroke(Color.BLACK, BorderStrokeStyle.SOLID, new CornerRadii(0.0F), new BorderWidths(0.0F))));
        loadedPercent.setBorder(new Border(new BorderStroke(Color.BLACK, BorderStrokeStyle.SOLID, new CornerRadii(0.0F), new BorderWidths(0.0F))));
        Total.setBackground(new Background(new BackgroundFill(Color.WHITE, new CornerRadii(0.0F), Insets.EMPTY)));
        required.setBackground(new Background(new BackgroundFill(Color.WHITE, new CornerRadii(0.0F), Insets.EMPTY)));
        loaded.setBackground(new Background(new BackgroundFill(Color.WHITE, new CornerRadii(0.0F), Insets.EMPTY)));
        error.setBackground(new Background(new BackgroundFill(Color.WHITE, new CornerRadii(0.0F), Insets.EMPTY)));
        requiredPercent.setBackground(new Background(new BackgroundFill(Color.WHITE, new CornerRadii(0.0F), Insets.EMPTY)));
    ...
    private HBox createTableHeader() {
        HBox hbox = new HBox();
        hbox.setSpacing(1.0F);
        hbox.setBackground(new Background(new BackgroundFill(Color.WHITE, new CornerRadii(0.0F), Insets.EMPTY)));
        hbox.setBorder(new Border(new BorderStroke(Color.BLACK, BorderStrokeStyle.SOLID, new CornerRadii(0.0F), new BorderWidths(1.0F, 1.0F, 1.0F, 1.0F))));
        Label number = new Label("No");
        number.setAlignment(Pos.CENTER);
        number.setTextAlignment(TextAlignment.CENTER);
        number.setPrefSize(this.width / (double) 14.0F, 40.0F);
        number.setBorder(new Border(new BorderStroke(Color.BLACK, BorderStrokeStyle.SOLID, new CornerRadii(0.0F), new BorderWidths(0.0F, 1.0F, 0.0F, 0.0F))));
        Label material = new Label("Material name");
        material.setAlignment(Pos.CENTER);
        material.setTextAlignment(TextAlignment.CENTER);
        material.setPrefSize(this.width / (double) 14.0F * (double) 3.0F, 40.0F);
        material.setBorder(new Border(new BorderStroke(Color.BLACK, BorderStrokeStyle.SOLID, new CornerRadii(0.0F), new BorderWidths(0.0F, 1.0F, 0.0F, 0.0F))));
        Label required = new Label("Required");
        required.setAlignment(Pos.CENTER);
        required.setTextAlignment(TextAlignment.CENTER);
        required.setPrefSize(this.width / (double) 7.0F, 40.0F);
        required.setBorder(new Border(new BorderStroke(Color.BLACK, BorderStrokeStyle.SOLID, new CornerRadii(0.0F), new BorderWidths(0.0F, 1.0F, 0.0F, 0.0F))));
        Label loaded = new Label("Loaded");
        loaded.setAlignment(Pos.CENTER);
        loaded.setTextAlignment(TextAlignment.CENTER);
        loaded.setPrefSize(this.width / (double) 7.0F - (double) 1.0F, 40.0F);
        loaded.setBorder(new Border(new BorderStroke(Color.BLACK, BorderStrokeStyle.SOLID, new CornerRadii(0.0F), new BorderWidths(0.0F, 1.0F, 0.0F, 0.0F))));
        Label error = new Label("Error");
        error.setAlignment(Pos.CENTER);
        error.setTextAlignment(TextAlignment.CENTER);
        error.setPrefSize(this.width / (double) 7.0F, 40.0F);
        error.setBorder(new Border(new BorderStroke(Color.BLACK, BorderStrokeStyle.SOLID, new CornerRadii(0.0F), new BorderWidths(0.0F, 1.0F, 0.0F, 0.0F))));
        ...
        rewuiredPercentage.setPrefSize(this.width / (double) 7.0F - (double) 1.0F, 40.0F);
        rewuiredPercentage.setBorder(new Border(new BorderStroke(Color.BLACK, BorderStrokeStyle.SOLID, new CornerRadii(0.0F), new BorderWidths(0.0F, 1.0F, 0.0F, 0.0F))));
        ...
        actualPercentage.setPrefSize(this.width / (double) 7.0F - (double) 1.0F, 40.0F);
        actualPercentage.setBorder(new Border(new BorderStroke(Color.BLACK, BorderStrokeStyle.SOLID, new CornerRadii(0.0F), new BorderWidths(0.0F, 1.0F, 0.0F, 0.0F))));
