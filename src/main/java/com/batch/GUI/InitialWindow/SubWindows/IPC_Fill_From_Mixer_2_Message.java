...
public class IPC_Fill_From_Mixer_2_Message extends Stage {
    ...
    private void initialization() {
        ...
        ok.setOnMouseClicked((action) -> {
            ((BooleanDataType)((RowDataDefinition)this.allDataDefinitions.get("General")).getAllValues().get(GeneralOutput.IPC_Fill_From_Mixer_2_Message_Confirmation)).setValue(true);
            this.hide();
        });
