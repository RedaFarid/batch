...
public class IPC_Fill_From_Mixer_1_Message extends Stage {
    private static IPC_Fill_From_Mixer_1_Message singleton = null;
    ...
    private IPC_Fill_From_Mixer_1_Message(Stage stage, Map<String, RowDataDefinition> allDataDefinitions) {
    ...
    public static Stage getWindow(Stage stage, Map<String, RowDataDefinition> allDataDefinitions) {
        if (singleton == null) {
            synchronized(IPC_Fill_From_Mixer_1_Message.class) {
                singleton = new IPC_Fill_From_Mixer_1_Message(stage, allDataDefinitions);
            }
        }
    ...
    private void initialization() {
        Label label = new Label("Mixer - 1 feeding IPC container phase started");
        ...
        Label content = new Label("Kindly add IPC container and insert flexible hose inside it from V21,\nAfter adjusting setup please press [CONFIRMED] ");
        ...
        ok.setOnMouseClicked((action) -> {
            ((BooleanDataType)((RowDataDefinition)this.allDataDefinitions.get("General")).getAllValues().get(GeneralOutput.IPC_Fill_From_Mixer_1_Message_Confirmation)).setValue(true);
            this.hide();
        });
        ...
        this.setScene(scene);
        this.setTitle("Mixer 1 IPC container filling");
