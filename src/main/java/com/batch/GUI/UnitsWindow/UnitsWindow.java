...
public class UnitsWindow extends Stage {
    ...
    private final Label label = new Label("Unit name");
    private final TextField field = new TextField();
    private final Button button = new Button("Add new Unit");
    private final BorderPane root = new BorderPane();
    private final ListView<Unit> view = new ListView();
    ...
    private void graphicsBuilder() {
        ...
        this.bar.getItems().addAll(this.label, this.field, this.button);
