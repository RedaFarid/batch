...
class ReceiveDataMapper implements Runnable {
    ...
    public ReceiveDataMapper(Map<String, RowDataDefinition> definitions, Map<Integer, Byte> buffer, NotificationService loggingService) {
    ...
    public void run() {
        ...
        try {
            ...
            log.fatal(e, e);
            this.loggingService.newErrorMessage("Modbus receiver data mapper", "Main run", StringUtilsL.textLimiter(e.getMessage(), 40));
        }
